    ...
    >
      ...
      >
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              name="name"
              required
              className="w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 outline-none focus:ring-2 focus:ring-indigo-500/60 focus:border-white/20 text-white placeholder:text-white/40"
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="inline-flex items-center justify-center rounded-xl px-6 py-3 bg-gradient-to-r from-indigo-500 to-violet-500 text-white font-semibold hover:from-indigo-400 hover:to-violet-400 ring-glow"
          >
            Send Message
          </button>
        </div>
